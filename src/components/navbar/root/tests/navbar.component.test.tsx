...
import NavBarColourModeContainer from "@src/components/navbar/colour.mode/navbar.colour.mode.container";
import mockNavBarLayoutControllerHook from "@src/components/navbar/controllers/__mocks__/navbar.layout.controller.hook.mock";
import NavBarLogo from "@src/components/navbar/logo/navbar.logo.component";
import NavBarMobileMenu from "@src/components/navbar/mobile.menu/navbar.mobile.menu.component";
...
jest.mock(
  "@src/components/navbar/colour.mode/navbar.colour.mode.container",
  () =>
...
jest.mock("@src/components/navbar/logo/navbar.logo.component", () =>
  require("@fixtures/react/parent").createComponent("NavBarLogo")
);

jest.mock(
  "@src/components/navbar/mobile.menu/navbar.mobile.menu.component",
...
jest.mock(
  "@src/components/navbar/session.control/navbar.session.control.container",
  () =>
...
jest.mock("@src/components/navbar/spinner/navbar.spinner.component", () =>
