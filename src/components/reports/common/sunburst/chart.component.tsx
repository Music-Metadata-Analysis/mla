...
class SunBurstChart extends Component<SunBurstChartProps> {
  ...
  componentDidUpdate(prevProps: SunBurstChartProps) {
    if (
  ...
  private updateColours = (colourSet: SunBurstChartProps["colourSet"]) => {
    this.graphic.g
  ...
  render() {
    return (
      <svg
        ...
        data-testid={testIDs.SunBurstChart}
