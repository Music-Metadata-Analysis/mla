...
jest.mock(
  "@src/components/reports/lastfm/common/drawer/sunburst/nodes/node.list/node.list.container",
  () =>
...
jest.mock(
  "@src/components/reports/lastfm/common/drawer/sunburst/panels/control/drawer.control.panel.container",
  () =>
    require("@fixtures/react/child").createComponent(
...
jest.mock(
  "@src/components/reports/lastfm/common/drawer/sunburst/panels/title/drawer.title.panel.container",
  () =>
    require("@fixtures/react/child").createComponent(
...
describe("LastFMSunBurstReportDrawer", () => {
  ...
  const baseProps: LastFMSunBurstDrawerInterface = {
    alignment: "left" as const,
    isOpen: true,
    nodeListScrollRef: mockNodeListScrollRef,
    node: new MockSunBurstNodeEncapsulation(mockReportState),
    onClose: mockClose,
