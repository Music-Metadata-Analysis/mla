...
jest.mock("@src/components/reports/common/chart/sunburst/chart.component", () =>
  require("@fixtures/react/parent").createComponent("SunBurstChart")
);

jest.mock(
  "@src/components/reports/lastfm/common/report.component/sunburst/panels/control/control.panel.component",
  () =>
    require("@fixtures/react/parent").createComponent("SunBurstControlPanel")
);

jest.mock(
  "@src/components/reports/lastfm/common/report.component/sunburst/panels/error/error.panel.component",
  () => require("@fixtures/react/parent").createComponent("SunBurstErrorPanel")
);

jest.mock(
  "@src/components/reports/lastfm/common/report.component/sunburst/panels/info/info.panel.component",
  () => require("@fixtures/react/parent").createComponent("SunBurstInfoPanel")
);

jest.mock(
  "@src/components/reports/lastfm/common/report.component/sunburst/panels/title/title.panel.component",
    ...
    if (calls > 0) {
      it("should render the DrawerComponent with the correct props", () => {
        ...
        checkMockCall(
          ...
          [],
          false,
          [{ name: "node", class: MockSunBurstNodeEncapsulation }]
        );
      });
    }
  };
