...
import {
  ...
  calculateLayoutType,
} from "../sunburst.report.layout";
import useSunBurstLayoutController, {
  SunBurstLayoutFlexProps,
} from "../sunburst.report.layout.hook";
import mockHookValues from "@src/components/reports/lastfm/common/report.component/sunburst/controllers/__mocks__/sunburst.report.layout.hook.mock";

jest.mock("../sunburst.report.layout", () => ({
