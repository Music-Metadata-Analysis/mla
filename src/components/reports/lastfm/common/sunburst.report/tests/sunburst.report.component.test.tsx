...
const SunBurstReportBaseProps: SunBurstReportProps<MockUserStateEncapsulation> =
  {
    userState: new MockUserStateEncapsulation(mockUserProperties),
...
describe("SunBurstReport", () => {
  let currentProps: SunBurstReportProps<MockUserStateEncapsulation>;

  beforeEach(() => jest.clearAllMocks());

  const resetProps = () => {
    currentProps = { ...SunBurstReportBaseProps };
  };

  const arrange = () => {
    return render(<SunBurstReport {...currentProps} />);
  };
