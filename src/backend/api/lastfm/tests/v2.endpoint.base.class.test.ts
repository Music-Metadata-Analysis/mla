...
import FlagClient from "../../../integrations/flags/flagsmith.client.class";
...
jest.mock("../../../integrations/flags/flagsmith.client.class", () =>
  jest.fn(() => ({
