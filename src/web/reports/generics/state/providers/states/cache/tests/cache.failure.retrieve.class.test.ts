import ReducerState from "../cache.failure.retrieve.class";
...
const testType = "FailureRetrieveCachedReport";
...
describe(testType, () => {
  ...
  const completeReport = { ...stateFixture, inProgress: true, ready: false };
