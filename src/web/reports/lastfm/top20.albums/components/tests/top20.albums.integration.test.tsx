...
describe("Top20AlbumsContainer", () => {
  let currentProps: Top20AlbumsReportContainerProps;
  ...
  const resetProps = () => {
    ...
    currentProps.lastfm.reportProperties.data.report.albums = {
      ...mockAlbumData,
    };
  };
  ...
  const arrange = () => {
    return render(
      <ChakraProvider>
        <Top20AlbumsContainer {...currentProps} />
      </ChakraProvider>
    );
  };
