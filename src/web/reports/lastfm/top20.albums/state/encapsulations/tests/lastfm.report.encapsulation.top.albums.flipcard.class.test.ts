...
import LastFMReportFlipCardTopAlbumsStateEncapsulation from "../lastfm.report.encapsulation.top.albums.flipcard.class";
...
describe("LastFMReportFlipCardTopAlbumsStateEncapsulation", () => {
  let currentState: LastFMReportStateAlbumReport;
  let instance: LastFMReportFlipCardTopAlbumsStateEncapsulation;
  ...
  const arrange = () => {
    instance = new LastFMReportFlipCardTopAlbumsStateEncapsulation(
      currentState,
      mockT
    );
  };
  ...
  describe("when initialized", () => {
    ...
    describe("getDataSource", () => {
      ...
      it("should return the correct data", () => {
        expect(data).toBe(instance.reportProperties.data.report.albums);
      });
    });
  });
