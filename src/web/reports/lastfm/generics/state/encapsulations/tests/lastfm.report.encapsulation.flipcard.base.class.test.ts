import ConcreteBaseReportState from "./implementations/concrete.lastfm.report.encapsulation.flipcard.class";
import {
  baseReportProperties,
  mockUrls,
} from "../bases/tests/states/lastfm.report.state.data.set";
...
describe("LastFMReportFlipCardBaseStateEncapsulation", () => {
  ...
  let instance: LastFMReportFlipCardBaseStateEncapsulation;
