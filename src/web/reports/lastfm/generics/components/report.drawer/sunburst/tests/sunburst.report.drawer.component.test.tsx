...
import SunBurstNodeListContainer from "@src/web/reports/lastfm/generics/components/report.drawer/sunburst/nodes/node.list/node.list.container";
...
jest.mock(
  "@src/web/reports/lastfm/generics/components/report.drawer/sunburst/nodes/node.list/node.list.container",
  () =>
...
jest.mock(
  "@src/web/reports/lastfm/generics/components/report.drawer/sunburst/panels/control/drawer.control.panel.container",
  () =>
    require("@fixtures/react/child").createComponent(
...
jest.mock(
  "@src/web/reports/lastfm/generics/components/report.drawer/sunburst/panels/title/drawer.title.panel.container",
  () =>
    require("@fixtures/react/child").createComponent(
...
jest.mock(
  "@src/web/reports/generics/components/report.drawer/report.drawer.component",
