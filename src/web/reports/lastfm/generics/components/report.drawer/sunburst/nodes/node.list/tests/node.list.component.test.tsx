...
jest.mock(
  "@src/web/reports/lastfm/generics/components/report.drawer/sunburst/nodes/node.button/node.button.component",
  () => require("@fixtures/react/parent").createComponent("SunBurstNodeButton")
);

jest.mock(
  "@src/web/reports/lastfm/generics/components/report.drawer/sunburst/nodes/node.display/node.display.component",
