import LegacyReportCacheCreateEndpointFactoryV2, {
  EndpointSunsetDate,
} from "@src/api/services/report.cache/endpoints/v2.legacy.report.cache.create.endpoint.factory.class";
...
const endpointUnderTest = apiRoutes.v2.cacheLegacyCreate;
  ...
  describe("an instance of the endpoint factory class", () => {
    it("should be an instance of ReportCacheCreateEndpointFactoryV2", () => {
      expect(endpointFactory).toBeInstanceOf(
        LegacyReportCacheCreateEndpointFactoryV2
      );
    });
    ...
    describe("with valid data", () => {
      ...
      describe("receives a POST request", () => {
        ...
        describe("with a valid proxy response", () => {
          ...
          it("should return the correct Sunset header", () => {
            expect(mockRes._getHeaders()["sunset"]).toBe(
              EndpointSunsetDate.toString()
            );
          });
