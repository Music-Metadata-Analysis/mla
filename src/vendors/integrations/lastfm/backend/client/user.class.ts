...
import ArtistImageCacheFactory from "../cache/artist.image.cache.controller/artist.image.cache.controller.factory.class";
...
class LastFmUserClientAdapter
  ...
  implements LastFMVendorUserClientInterface
{
  cache: CacheVendorCdnControllerInterface<string>;
  reportCount = 20;
