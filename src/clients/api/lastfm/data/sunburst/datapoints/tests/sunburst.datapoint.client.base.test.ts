...
describe("LastFMBaseSunBurstDataClient", () => {
  ...
  describe("retrieveReport", () => {
    ...
    describe.only("when a request is successful", () => {
      beforeEach(() => {
    ...
    describe.only("when a request fails", () => {
      beforeEach(() => {
    ...
    describe.only("when a request is unauthorized", () => {
      beforeEach(() => {
    ...
    describe.only("when a request returns not found", () => {
      beforeEach(() => {
    ...
    describe.only("when a request is ratelimited", () => {
      beforeEach(() => {
    ...
    describe.only("when a request time out", () => {
      beforeEach(() => {
        mockState.getDispatchState.mockImplementation(
          () => mockInCompleteReport
        );
