  ...
  describe("when in production", () => {
    ...
    describe("without a valid tracker code", () => {
      ...
      describe("when initialized", () => {
        ...
        it("should NOT initialize analytics when setup is called", async () => {
          received.result.current.setup();
          expect(ReactGA.initialize).toBeCalledTimes(0);
        });

        it("should NOT set initialized to true when setup is called", async () => {
          received.result.current.setup();
    ...
    describe("with a valid tracker code", () => {
      ...
      describe("when not initialized", () => {
        ...
        it("should initialize analytics when setup is called", async () => {
          received.result.current.setup();
        ...
        it("should set initialized to true when setup is called", async () => {
          received.result.current.setup();
