        ...
        it("should modify the results as expected", () => {
          ...
          expected.data.report.playCountByArtist.status = {
            ...
            operation: {
              ...
              url: "/api/v2/reports/lastfm/top20artists/niall-byrne",
            },
          };
        ...
        it("should attach the results as expected", () => {
          ...
          expected.data.report.playCountByArtist.status = {
            ...
            operation: {
              ...
              url: "/api/v2/data/artists/Lights%20%26%20Motion/albums?username=niall-byrne",
            },
          };
          expect(instance.userProperties).toStrictEqual(expected);
        });
        ...
        it("should attach the results as expected", () => {
          ...
          expected.data.report.playCountByArtist.status = {
            ...
            operation: {
              ...
              url: "/api/v2/data/artists/The%20Cure/albums/Greatest%20Hits?username=niall-byrne",
            },
          };
          expect(instance.userProperties).toStrictEqual(expected);
        });
        ...
        it("should attach the results as expected", () => {
          ...
          expected.data.report.playCountByArtist.status = {
            ...
            operation: {
              ...
              url: "/api/v2/data/artists/The%20Cure/albums/Disintegration/tracks/Plainsong?username=niall-byrne",
            },
          };
          expect(instance.userProperties).toStrictEqual(expected);
        });
      ...
      describe("with an a track info response", () => {
        it("should attach the results as expected", () => {
          ...
          expected.data.report.playCountByArtist.status = {
            ...
            steps_complete: 4,
            operation: {
              url: "/api/v2/data/artists/The%20Cure/albums/Disintegration/tracks/Lovesong?username=niall-byrne",
              resource:
                expected.data.report.playCountByArtist.content[12].albums[2]
                  .tracks[3].name,
              type: "Track Details",
